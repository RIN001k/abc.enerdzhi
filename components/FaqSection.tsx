...
const faqs: FaqItem[] = [
  {
    ...
    answer:
      "Оптимально починати з 2 років. У цьому віці дитина вже готова опановувати навчальні навички в ігровій формі, але при цьому не перевантажується. Ми підбираємо програму під вік і рівень готовності.",
  },
  {
    question: "Що, якщо дитина соромиться або важко йде на контакт?",
    answer:
      "Це цілком природно! Ми знаємо, як знайти підхід до кожного малюка. Наші педагоги діють дбайливо та поступово, використовуючи ігрові методики, щоб дитина почувалася в безпеці. Вже за кілька занять діти зазвичай самі з радістю біжать до групи.",
  },
  {
    question: "Чи потрібно робити домашні завдання?",
    answer:
      "Ми даємо посильні домашні завдання лише там, де це справді допомагає закріпити матеріал. Наша мета — не навантажити дитину, а сформувати звичку доводити розпочате до кінця.",
  },
  {
